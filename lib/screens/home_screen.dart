...
class _HomeScreenState extends State<HomeScreen> {
  ...
  var _menu = ["Armadilhas", "Clientes", "Visitas"];
  var _menuPages = [];
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              accountName: Text("Fabiano Gadenz", style: TextStyle(fontWeight: FontWeight.bold),),
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child:Center(
              child: Icon(Icons.ac_unit, color: Colors.green, size: 250.0,),
            ),
          ),
